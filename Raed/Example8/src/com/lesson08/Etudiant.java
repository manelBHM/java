...
public class Etudiant {
		  ...
		  **/
		  public void saisieNotes(int nbNote) {  //did we fix the number of subjects here ???? 
		  ...
		  **/
		  public double getNote(int index){  //needs to be clarified 
		    return this.notes[index];
		  }

		 
		  public double[] getNotes() { //needs to be clarified 
