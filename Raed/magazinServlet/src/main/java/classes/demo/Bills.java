...
public class Bills {
	...
	public double getTotal() {
		...
		for(Map.Entry<Product, Integer> element:products.entrySet()) {
			...
			buffer.append(element.getKey().getName()).append(", ").append("<br>").append(element.getKey().getDescription())
			.append(", ").append("<br>").append(element.getKey().getPrice()).append("Euros ").append("<br>")
			.append(element.getValue()).append(", ").append("<br><br>");
			total += element.getKey().getPrice()  * element.getValue();	
		}
		buffer.append("the total price is :  ");
	...
	public double coutTotal(Map<Product,Integer> p) {
		double d = 0.0;
	...
	///method to try later wit count
	/*
	 * public double getTotal() { double total = 0; for (Map.Entry<Product, Integer>
	 * str : map.entrySet()) { total += str.getKey().getPrice(); quantity =
	 * str.getValue(); }
	 * 
	...
	public StringBuffer showProducts(Map<Product,Integer> prod) {
		...
		buffer.append("the total price is :").append(this.getTotal()).append("<br>");
