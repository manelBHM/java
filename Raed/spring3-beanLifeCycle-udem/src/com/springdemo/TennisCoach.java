...
@Component
//@Scope("prototype") For "prototype" scoped beans, Spring does not call the @PreDestroy method.  Gasp! 
public class TennisCoach implements Coach {
	...
	*/
	...
	public void doMyInitMethod() {
		System.out.println("TennisCoach: inside ...doMyInitMethod()");
	}
	...
	public void doMyDestroyMethod() {
		System.out.println("TennisCoach: inside ...doMyDestroyMethod()");
	}
