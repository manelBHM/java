...
public class TestShop {
	...
	public static void main(String[] args) {
		...
		Customer c1 = new Customer("Stanley", "54 rue Beliard", 75021);
		...
		Delivery express  = new ExpressDelivery("Stanley", "54 rue Beliard", 75021);
		Delivery relay = new RelayDelivery(48);
		Delivery home = new HomeDelivery();
		
		
		Bill bill1 = new Bill(c1, home);
