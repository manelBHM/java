...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
   <a class="navbar-brand" href="/EPharma/EPharmaServlet">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/EPharma/Panier.jsp"><button type="button" class="btn btn-outline-success">Panier</button></a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="card-deck">
  <div class="card">
    <img src="http://miam-images.m.i.pic.centerblog.net/639978c4.png" class="card-img-top" alt="Tony">
    <div class="card-body">
      <h5 class="card-title">Tony</h5>
      <p class="card-text">Tony@simplon.ch</p>
    </div>
  ...
  <div class="card">
    <img src="http://miam-images.m.i.pic.centerblog.net/639978c4.png" class="card-img-top" alt="Hamza">
    <div class="card-body">
      <h5 class="card-title">Hamza</h5>
      <p class="card-text">Hamza@simplon.com</p>
    </div>
    <div class="card-footer">
		<button>Contact</button>
    </div>
  ...
  <div class="card">
    <img src="http://miam-images.m.i.pic.centerblog.net/639978c4.png" class="card-img-top" alt="Lucky">
    <div class="card-body">
      <h5 class="card-title">Lucky</h5>
      <p class="card-text">Lucky@simplon.com</p>
    </div>
    <div class="card-footer">
      <button>Contact</button>
    </div>
