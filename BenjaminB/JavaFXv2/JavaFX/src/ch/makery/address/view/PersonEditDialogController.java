...
public class PersonEditDialogController {
    ...
    public void setPerson(Person person) {
        ...
        PrénomField.setText(person.getPrénom());
    ...
    private void handleOk() {
        if (isInputValid()) {
            person.setPrénom(PrénomField.getText());
          ...
          //  String sql="UPDATE users SET prenom = '"+PrénomField+"' WHERE id = ;"
            okClicked = true;
            dialogStage.close();
        }
    }
    ...
    private boolean isInputValid() {
        ...
        if (PrénomField.getText() == null || PrénomField.getText().length() == 0) {
