...
<body>
	...
	<nav class="navbar navbar-light bg-primary">
		...
		<ul class="nav justify-content-center">
			...
			<li class="nav-item"><a class="nav-link" href="http://localhost:8080/MyMarketWeb/ProductServlet">Profile</a></li>
		</ul>
	...
	<h1 style="text-decoration: underline;">Login Or Register</h1>
	<div class="row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="password" name="pass" class="form-control" id="inputPass" placeholder="Password" required>
    </div>
  </div>
    <div class="form-group row">
    <label for="inputFile" class="col-sm-2 col-form-label">Avatar</label>
    <div class="col-sm-10">
      <input type="file" name="avatar" class="form-control" id="inputFile" placeholder="Avatar" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-sm-10">
      ...
      <p style="margin-top: 15px;">I have an account <a href="login.jsp"> Login </a> </p>
    </div>
  </div>
</form>
</div>
